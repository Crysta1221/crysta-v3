...
export const PCViewport = () => {
  ...
  return (
    <div className='relative w-fit items-center rounded-full p-1.5 hidden md:inline-flex bg-[#f5f5f5] dark:bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10'>
